  ...
  return (
    <div>
      ...
      >
        ...
        <BiChevronLeft
          className={`${isOpen ? "-rotate-90" : ""} duration-300 text-3xl`}
        />
      </div>
      <div
        className={`${isOpen ? "h-full px-10 py-6" : "h-0! opacity-0 invisible overflow-hidden p-0! whitespace-nowrap"} duration-300 transition-all text-sm  text-slate-500`}
      >
        {content}
      </div>
    </div>
